...
import CustomCalendar from "../schedule/screens/CalendarScreen/Calendar";
export default function CalendarModal({ isModalVisible, setIsModalVisible }: { isModalVisible: boolean, setIsModalVisible: React.Dispatch<React.SetStateAction<boolean>> }) {
